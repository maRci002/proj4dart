...
final MERIT = Ellipsoid(a: 6378137.0, rf: 298.257, ellipseName: 'MERIT 1983');
...
final IAU76 = Ellipsoid(a: 6378140.0, rf: 298.257, ellipseName: 'IAU 1976');
...
final delmbr =
    Ellipsoid(a: 6376428.0, rf: 311.5, ellipseName: 'Delambre 1810 (Belgium)');
...
final fschr68 = Ellipsoid(a: 6378150.0, rf: 298.3, ellipseName: 'Fischer 1968');

final helmert = Ellipsoid(a: 6378200.0, rf: 298.3, ellipseName: 'Helmert 1906');

final hough = Ellipsoid(a: 6378270.0, rf: 297.0, ellipseName: 'Hough');

final intl = Ellipsoid(
    a: 6378388.0, rf: 297.0, ellipseName: 'International 1909 (Hayford)');

final kaula = Ellipsoid(a: 6378163.0, rf: 298.24, ellipseName: 'Kaula 1961');

final lerch = Ellipsoid(a: 6378139.0, rf: 298.257, ellipseName: 'Lerch 1979');
...
final WGS60 = Ellipsoid(a: 6378165.0, rf: 298.3, ellipseName: 'WGS 60');

final WGS66 = Ellipsoid(a: 6378145.0, rf: 298.25, ellipseName: 'WGS 66');

final WGS7 = Ellipsoid(a: 6378135.0, rf: 298.26, ellipseName: 'WGS 72');

final WGS84 = Ellipsoid(a: 6378137.0, rf: 298.257223563, ellipseName: 'WGS 84');
