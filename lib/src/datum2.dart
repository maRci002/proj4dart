...
class Datum {
  ...
  Datum(String datumCode, List<String> datumParams, a, b, es, ep2) {
    if (datumCode == null || datumCode == 'none') {
      datum_type = ConstValues.PJD_NODATUM;
    } else {
      datum_type = ConstValues.PJD_WGS84;
    }
    if (datumParams != null) {
      ...
      if (datum_params[0] != 0 ||
          datum_params[1] != 0 ||
          datum_params[2] != 0) {
        datum_type = ConstValues.PJD_3PARAM;
      }
      if (datum_params.length > 3) {
        if (datum_params[3] != 0 ||
            ...
            datum_params[5] != 0 ||
            datum_params[6] != 0) {
          datum_type = ConstValues.PJD_7PARAM;
          datum_params[3] *= ConstValues.SEC_TO_RAD;
          datum_params[4] *= ConstValues.SEC_TO_RAD;
          datum_params[5] *= ConstValues.SEC_TO_RAD;
